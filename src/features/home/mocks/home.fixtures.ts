...
const homeByLanguage: Record<AppLanguage, HomeContent> = {
  ...
  es: {
    hero: {
      ...
      title: 'Ayuda a las personas viajeras a construir un primer plan facil y bonito para Bacalar.',
      description:
    ...
    planningCallout: {
      ...
      description:
        'Lidera con la laguna, acompana el dia con algunos restaurantes fuertes, agrega eventos solo como mejoras y mantén visible la ruta de reserva.',
      items: [
    ...
    featuredExperiences: {
      intro: {
        ...
        description:
          'Mantén la homepage enfocada en un pequeno numero de opciones de alta confianza en lugar de mostrarlo todo.',
      },
      items: [
        {
    ...
    weeklyHappenings: {
      intro: {
        ...
        description:
          'Mantén la cobertura de eventos selectiva para que aporte textura sin competir con el flujo principal del plan.',
      },
      items: [
        {
    ...
    bookingCta: {
      ...
      description:
        'Mantén simple la entrega final: fecha de viaje, numero de huespedes y expectativas claras de confirmacion. La homepage debe cerrar mostrando que iniciar la reserva es facil.',
      primaryAction: {
