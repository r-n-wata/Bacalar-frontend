  ...
  en: {
    translation: {
      ...
      events: {
        ...
        filters: {
          controlsLabel: 'Event search and filters',
          button: 'Filters',
          title: 'Filter events',
          description: 'Refine the events list by category or search text.',
          close: 'Close',
          searchLabel: 'Search events',
          searchPlaceholder: 'Search by event, venue, category, or timing',
          resultsCount_one: 'Showing {{count}} event',
          resultsCount_other: 'Showing {{count}} events',
          searchChip: 'Search: {{value}}',
          clearAll: 'Clear all',
          previewLoading: 'Checking events...',
          applyCount_one: 'Show {{count}} event',
          applyCount_other: 'Show {{count}} events',
          removeFilter: 'Remove filter {{label}}',
          emptyTitle: 'No events match these filters right now.',
          emptyDescription:
      ...
      restaurants: {
        ...
        filters: {
          controlsLabel: 'Restaurant search and filters',
          button: 'Filters',
          title: 'Filter restaurants',
          description:
            'Refine the restaurants list by meal moment, price band, or search text.',
          close: 'Close',
          searchLabel: 'Search restaurants',
          searchPlaceholder: 'Search by restaurant, cuisine, vibe, or moment',
          resultsCount_one: 'Showing {{count}} restaurant',
          resultsCount_other: 'Showing {{count}} restaurants',
          searchChip: 'Search: {{value}}',
          priceTitle: 'Price band',
          priceAll: 'All price bands',
          priceBandChip: 'Price: {{value}}',
          clearAll: 'Clear all',
          previewLoading: 'Checking restaurants...',
          applyCount_one: 'Show {{count}} restaurant',
          applyCount_other: 'Show {{count}} restaurants',
          removeFilter: 'Remove filter {{label}}',
          emptyTitle: 'No restaurants match these filters right now.',
          emptyDescription:
            'Try widening your search or clearing one of the active filters.',
        },
      ...
      tours: {
        ...
        filters: {
          controlsLabel: 'Tour search and filters',
          button: 'Filters',
          title: 'Filter tours',
          description: 'Refine the tours list by category, price, duration, or search text.',
          close: 'Close',
          searchLabel: 'Search tours',
          searchPlaceholder: 'Search by tour, operator, category, or vibe',
          resultsCount_one: 'Showing {{count}} tour',
          resultsCount_other: 'Showing {{count}} tours',
          searchChip: 'Search: {{value}}',
          priceTitle: 'Price',
          priceMin: 'Minimum MXN',
          priceMax: 'Maximum MXN',
          priceMinChip: 'Min {{value}} MXN',
          priceMaxChip: 'Max {{value}} MXN',
          priceHint: 'Use MXN amounts only.',
          priceValidation: 'Minimum price cannot be greater than maximum price.',
          durationTitle: 'Duration',
          durationOption_one: '{{count}} hour',
          durationOption_other: '{{count}} hours',
          durationChip_one: '{{count}} hour',
          durationChip_other: '{{count}} hours',
          clearAll: 'Clear all',
          previewLoading: 'Checking tours...',
          applyCount_one: 'Show {{count}} tour',
          applyCount_other: 'Show {{count}} tours',
          removeFilter: 'Remove filter {{label}}',
          emptyDescription:
            'Try widening your search or clearing one of the active filters.',
        },
  ...
  es: {
    translation: {
      ...
      events: {
        ...
        filters: {
          controlsLabel: 'Busqueda y filtros de eventos',
          button: 'Filtros',
          title: 'Filtrar eventos',
          description: 'Refina la lista por categoria o texto de busqueda.',
          close: 'Cerrar',
          searchLabel: 'Buscar eventos',
          searchPlaceholder: 'Busca por evento, venue, categoria o momento',
          resultsCount_one: 'Mostrando {{count}} evento',
          resultsCount_other: 'Mostrando {{count}} eventos',
          searchChip: 'Busqueda: {{value}}',
          clearAll: 'Limpiar todo',
          previewLoading: 'Revisando eventos...',
          applyCount_one: 'Mostrar {{count}} evento',
          applyCount_other: 'Mostrar {{count}} eventos',
          removeFilter: 'Quitar filtro {{label}}',
          emptyTitle: 'No hay eventos para estos filtros en este momento.',
          emptyDescription:
            'Prueba una busqueda mas amplia o limpia alguno de los filtros activos.',
        },
      ...
      restaurants: {
        ...
        filters: {
          controlsLabel: 'Busqueda y filtros de restaurantes',
          button: 'Filtros',
          title: 'Filtrar restaurantes',
          description:
            'Refina la lista por momento de comida, rango de precio o texto de busqueda.',
          close: 'Cerrar',
          searchLabel: 'Buscar restaurantes',
          searchPlaceholder: 'Busca por restaurante, cocina, ambiente o momento',
          resultsCount_one: 'Mostrando {{count}} restaurante',
          resultsCount_other: 'Mostrando {{count}} restaurantes',
          searchChip: 'Busqueda: {{value}}',
          priceTitle: 'Rango de precio',
          priceAll: 'Todos los rangos',
          priceBandChip: 'Precio: {{value}}',
          clearAll: 'Limpiar todo',
          previewLoading: 'Revisando restaurantes...',
          applyCount_one: 'Mostrar {{count}} restaurante',
          applyCount_other: 'Mostrar {{count}} restaurantes',
          removeFilter: 'Quitar filtro {{label}}',
          emptyTitle: 'No hay restaurantes para estos filtros en este momento.',
          emptyDescription:
            'Prueba una busqueda mas amplia o limpia alguno de los filtros activos.',
        },
      ...
      tours: {
        ...
        filters: {
          controlsLabel: 'Busqueda y filtros de tours',
          button: 'Filtros',
          title: 'Filtrar tours',
          description: 'Refina la lista por categoria, precio, duracion o texto de busqueda.',
          close: 'Cerrar',
          searchLabel: 'Buscar tours',
          searchPlaceholder: 'Busca por tour, operador, categoria o plan',
          resultsCount_one: 'Mostrando {{count}} tour',
          resultsCount_other: 'Mostrando {{count}} tours',
          searchChip: 'Busqueda: {{value}}',
          priceTitle: 'Precio',
          priceMin: 'Minimo MXN',
          priceMax: 'Maximo MXN',
          priceMinChip: 'Min {{value}} MXN',
          priceMaxChip: 'Max {{value}} MXN',
          priceHint: 'Usa montos en MXN.',
          priceValidation: 'El precio minimo no puede ser mayor que el maximo.',
          durationTitle: 'Duracion',
          durationOption_one: '{{count}} hora',
          durationOption_other: '{{count}} horas',
          durationChip_one: '{{count}} hora',
          durationChip_other: '{{count}} horas',
          clearAll: 'Limpiar todo',
          previewLoading: 'Revisando tours...',
          applyCount_one: 'Mostrar {{count}} tour',
          applyCount_other: 'Mostrar {{count}} tours',
          removeFilter: 'Quitar filtro {{label}}',
          emptyDescription:
            'Prueba una busqueda mas amplia o limpia alguno de los filtros activos.',
        },
